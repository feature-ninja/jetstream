                            ...
                            <div className="hidden sm:flex sm:items-center sm:ml-6">
                                <div className="ml-3 relative">
                                    ...
                                    {page.props.jetstream.hasTeamFeatures && (
                                        <JetDropdown align="right" width="60" trigger={
                                ...
                                {/*Settings Dropdown*/}
                                <div className="ml-3 relative">
                                    <JetDropdown align="right" width="48" trigger={
                            ...
                            <div className="-mr-2 flex items-center sm:hidden">
                                <button onClick={() => setShowingNavigationDropdown(! showingNavigationDropdown)} className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
                                    <svg className="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                                        <path className={{'hidden': showingNavigationDropdown, 'inline-flex': ! showingNavigationDropdown }} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16" />
                                        <path className={{'hidden': ! showingNavigationDropdown, 'inline-flex': showingNavigationDropdown }} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                                </button>
                            </div>
                        </div>
                            ...
                            <div className="flex items-center px-4">
                                {page.props.jetstream.managesProfilePhotos && (
                                    <div className="flex-shrink-0 mr-3" >
                                        <img className="h-10 w-10 rounded-full object-cover" src={page.props.user.profile_photo_url} alt={page.props.user.name} />
                                    </div>
                                )}

                                <div>
                                    <div className="font-medium text-base text-gray-800">{page.props.user.name}</div>
                                    <div className="font-medium text-sm text-gray-500">{page.props.user.email}</div>
                                </div>
                            </div>
                            ...
                            <div className="mt-3 space-y-1">
                                ...
                                {page.props.jetstream.hasTeamFeatures && (
                                    <React.Fragment>
                                        ...
                                        <JetResponsiveNavLink href={route('teams.create')} active={route().current('teams.create')}>
                                            Create New Team
                                        </JetResponsiveNavLink>
