...
export default function Banner() {
    ...
    return (
        <div>
            {show && message && (
                <div className={classNames({'bg-indigo-500': style === 'success', 'bg-red-700': style === 'danger'})} v-if="show && message">
                    <div className="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
                        <div className="flex items-center justify-between flex-wrap">
                            ...
                            <div className="flex-shrink-0 sm:ml-3">
                                <button
                                    type="button"
                                    className={classNames('-mr-1 flex p-2 rounded-md focus:outline-none sm:-mr-2 transition ease-in-out duration-150', {
